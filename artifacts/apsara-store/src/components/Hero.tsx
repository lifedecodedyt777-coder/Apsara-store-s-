        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <p className="text-base text-muted-foreground mb-8 max-w-lg leading-relaxed">
              Discover authentic skincare, luxurious makeup, and premium fragrances. Apsara Store
              brings world-class personal care to your neighbourhood with expert, personalised
              guidance.
            </p>
